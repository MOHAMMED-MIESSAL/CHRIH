...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
    ...
    <section class="bg-white py-8">
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <div id="search_list" class="flex flex-wrap -mx-4 overflow-x-hidden">
                @foreach ($produits as $pro)
                    <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 px-4 mb-4  min-w-0">
                        <div class="p-6 flex flex-col bg-white shadow-md">
                            <a href="{{ route('produit', $pro->id) }}">
                                ...
                                <div class="pt-3 flex items-center justify-between">
                                    <div>
                                    <p>{{ $pro->title }}</p>
                                    <p style="color:white; background-color: gray; border-radius: 5px; width: fit-content; padding: 2px 4px;">{{ $pro->category->name }}</p>
                                </div>
                                </div>
                            </a>
                            @auth
