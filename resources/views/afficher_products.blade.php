            ...
            <div>
                ...
                <div class="p-6 mb-8 border bg-gray-50 dark:bg-gray-800 dark:border-gray-800">
                    <div class="flex-wrap items-center hidden mb-6 -mx-4 md:flex md:mb-8">
                        ...
                        <div class="w-auto px-4 text-right md:w-1/6 lg:w-2/12 " style="text-align: left"> 
                            <h2 class="font-bold text-gray-500 dark:text-gray-400"> Quantité</h2>
                        </div>
                    </div>
                                ...
                                <div class="flex flex-wrap items-center -mx-4">
                                    <div class="w-full px-4 mb-3 md:w-1/3">
                                        <div class="w-full h-96 md:h-24 md:w-24">
                                            <img src="{{ asset('storage/' . $commande->produit->image) }}" alt="" class="object-contain w-full h-full">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="hidden px-4 lg:block lg:w-2/12">
                                <p class="text-lg font-bold text-blue-500 dark:text-gray-400">{{ $commande->produit->title }}</p>
                            </div>
                        
                            <div class="hidden px-4 lg:block lg:w-2/12">
                                <p class="text-lg font-bold text-blue-500 dark:text-gray-400">{{ $commande->produit->prix }}</p>
                            </div>
                            <div class="hidden px-4 lg:block lg:w-2/12">
                                <p class="text-lg font-bold text-blue-500 dark:text-gray-400">{{ $commande->qte }}</p>
                            </div>
